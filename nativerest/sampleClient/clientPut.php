<?php
$id = '1'; // item id that will update
// URL API
$url = 'http://localhost:8888/nativerest/api/Sensor_repo/'.$id;

$client = curl_init();

$data = array("sensor_id"=>"11111","sensor_type"=>"water", "timestamp"=>"2003-04-02 08:00:00", "value"=>"11.32");
